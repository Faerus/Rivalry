...
contract PreSaleContract is Ownable {
    ...
    IToken private revoToken;
    IToken private usdtToken;
    ...
    */
    constructor(address revoTokenAddress, address _usdtAddress, uint256 maxCapRevoInWei) public {
